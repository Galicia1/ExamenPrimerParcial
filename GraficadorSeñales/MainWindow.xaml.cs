    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental >= 398 && frecuenciaFundamental <= 402)
                {

                    lblColor.Text = "Rojo";
                }
                if (frecuenciaFundamental >= 798 && frecuenciaFundamental <= 802)
                {

                    lblColor.Text = "Verde";
                }
                if (frecuenciaFundamental >= 1198 && frecuenciaFundamental <= 1202)
                {

                    lblColor.Text = "Morado";
                }
                if (frecuenciaFundamental >= 1598 && frecuenciaFundamental <= 1602)
                {

                    lblColor.Text = "Azul";
                }
                if (frecuenciaFundamental >= 1998 && frecuenciaFundamental <= 2002)
                {
